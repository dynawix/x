<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Veeraxml.Default" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4>Explore top-rated Hotels, activities and more</h4>
...
================================================== -->
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="headline centered margin-top-75">Browse Categories
                </h3>
            </div>
    ...
    <section class="fullwidth margin-top-65 padding-top-75 padding-bottom-70" data-background-color="#f8f8f8">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="headline centered margin-bottom-45">Most Visited Places
